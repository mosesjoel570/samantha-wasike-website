...
Write-Host " PREMIUM SERVICES - PART 3" -ForegroundColor Green
Write-Host "====================================================" -ForegroundColor Cyan
Write-Host ""
...
$Backup = "..\backups\PremiumServices_$Time"

New-Item -ItemType Directory -Force -Path $Backup | Out-Null
Copy-Item $File "$Backup\Services.tsx"
...
Write-Host ""
Write-Host "[OK] Premium Services installed successfully." -ForegroundColor Green
Write-Host ""
Write-Host "====================================================" -ForegroundColor Cyan
